...
namespace Lista2PR2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Para gerar números inteiros e reais aleatórios é preciso usar a classe 'random', que permite gerar um a sequência de números aleatórios com uma distribuição uniforme.
            //Para isso podemos usar o método next() da classe ramdom, passando o valor mínimo e máximo desejado como argumentos.
            //Por exemplo, para gerar um número interior entre 1 e 10, usa-se o seguinte código:

            //Random random = new Random();
            //int randomNumber = random.Next(1, 11); 

            //Para gerar um número real aleatório em um determinado intervalo, podemos usar o método NextDouble() da classe random, que retorna um número aleatório entre 0 e 1. Podemos então ajustar o valor do número gerado para o intervalo desejado.
